...
<body>
        ...
        <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active" id="slide-01">
                    <div class="d-flex h-100 align-items-center justify-content-end">
                        <div class="col text-right">
                            <h1 class="color-white font-weight-bold mr-3">Aprovechá tu tiempo<br>al máximo<br><span class="color-yellow">Cursos Online</span></h1>
                            <div class="col-8 col-md-4 ml-auto mb-5">
                                <p class="h2 color-white py-1 ml-auto bullet-circle">Inglés</p>
                ...
                <div class="carousel-item text-right" id="slide-02">
                    <div class="d-flex h-100 align-items-center justify-content-end">
                        <div class="col text-right">
                            <h1 class="color-white font-weight-bold mr-3">La mejor inversión en<br>Recursos Humanos</h1>
    ...
    <div class="container">
        ...
        <div class="row justify-content-around">
            <div class="col-md-5 card mb-3"><img src="images/presentation_high_view.jpg" alt="Presentación de la clase" class="card-img-top"></div>
        ...
        <!--
        <div class="mt-5 pt-3 border border-success rounded">
            <p class="lead text-center">Muchas empresas han confiado en nosotros para posicionarse mejor a la hora de competir internacionalmente.</p>
        </div>
        -->
        ...
        <div class="row justify-content-start justify-content-md-around align-items-center mt-2" id="individual">
            <div class="col-md-7 card my-3"><img src="images/online_student.png" alt="Estudiante en línea" class="card-img-top"></div>
            <div class="col-md-5">
        ...
        <div class="row justify-content-around mb-5">
            <div class="col-md-6">
                <div class="row">
                    <div class="col-4 col-md-3 justify-content-center align-items-center">
                        <img src="images/kc-profile-photo.jpg" alt="Karina Coco" class="rounded-circle profile-photo">
                    </div>
            ...
            <div class="col-md-6 mt-3 mt-md-0">
                <div class="row">
                    <div class="col-4 col-md-3 justify-content-center align-items-center">
                        <img src="images/dummy-profile-image-female.jpg" alt="Mónica Villar" class="rounded-circle profile-photo">
                    </div>
                    <div class="col-8 col-md-9">
